...
<div id="mySidebar" class="sidebar">
  ...
  <hr>
    <div id="container">
      <img id="profilepic" src="assets/profilepic.png"> <p class="font-size: 15px;"><?php echo $row["USERNAME"]; ?></p>
  </div>
  <div id="admininfo">
    <p>Online</p>
  ...
  <a href="logout.php">Logout</a>
	...
	<div id="navbar" style="width: 100%; color:blue; ">
		<div id="main">
		  <button class="openbtn" onclick="openNav()">☰</button>  
		</div>
      <div>
        <div id="navnav">Admin Login</div>
      </div>
