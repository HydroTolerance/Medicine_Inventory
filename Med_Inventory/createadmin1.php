...
if(isset($_POST["submit"])){
  ...
  if($_FILES["image"]["error"] == 4){
    ...
    if ( !in_array($imageExtension, $validImageExtension) ){
      ...
      $query = "INSERT INTO `medicines_admin`(`medicine`,`image`, `quantity`, `type`,`price`, `expirydate`) VALUES ('$medicine','$fileName','$quantity','$type','$price','$date')";
      mysqli_query($variable, $query);
      echo "<script> alert('Successfully Added'); document.location.href = landingadmin1.php'; </script>";
    }
  }
}
?>
...
<div class="p-4 header bg-primary text-white">
        <h3 class="p-3 text-center">Request to add a Medicine Product</h3>
    </div>
        ...
        <div class="">
            ...
            <label for="formFileLg" class="form-label">Image Preview:</label>
              ...
              <div >
                ...
                <input class="form-control form-control-lg" type="text" placeholder="Medicine" name="medicine" >
              </div>
              <div >
                <label for="formFileLg" class="form-label">Quantity of Medicine:</label>
                <input class="form-control form-control-lg" type="number" min="0" step="1" name="quantity" >
              </div>
                
                
                <div >
                <label for="formFileLg" class="form-label">Types</label>
                <select name="type" id="usertype"  class="form-select form-select" aria-label=".form-select" >
                ...
                <label for="formFileLg" class="form-label">Prices</label><br>
                    <input type="number" min="0" step="1" name="price" class="form-control form-control-lg" ><br>
                    ...
                    <a class="btn btn-danger" href="landingstaff.php">Cancel</a>
                </div>
        </form>
        </div>
    </div>
