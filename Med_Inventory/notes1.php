...
<div class="buttons">
  <div class="button1">
    <a onclick="window.location.href='noteadd1.php';">
...
<a onclick="return confirm('Are you sure! You want to delte this?')" href="notedelete1.php?id=<?php echo $row["ID"]; ?>"><img id="icon" src="assets/delete.png"></a>
<?php $count++; } ?>
