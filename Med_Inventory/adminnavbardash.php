...
<div id="navbar" style="width: 100%; background-color: white; padding-top:10px; padding-bottom: 30px;">
	<div id="main1">  
      <div class="design">
        <label style="color:rgb(52, 147, 215); font-size: 30px; margin-top: 20px; margin-left:30px;">Hello Admin!</label>
        <div class="end">
          <div class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              <a href="notes.php"><span class="material-symbols-outlined" style="font-size: 40px; margin-top: 15px; margin-right:25px; color:#000;">assignment_add</span></a>
              <a href="settings.php?ID=<?php echo $row['ID']?>"><span class="material-symbols-outlined" style="font-size: 40px; margin-top: 15px; color:#000;">settings</span></a>
        </div>
      </div>
